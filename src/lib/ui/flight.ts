...
export function flightKeyframes(verb: string, { dx, dy, peakRel, rimRel, sourceClearRel = peakRel, spin }: FlightGeometry): Keyframe[] {
...
export function flightOptions(motion: Motion, index: number) {
  return {

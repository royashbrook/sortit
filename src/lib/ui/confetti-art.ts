...
function polygon(g: CanvasRenderingContext2D, points: [number, number][]) {
  g.beginPath()
...
export function drawConfettiPiece(g: CanvasRenderingContext2D, skin: string, color: string, variant: number) {
  g.fillStyle = color

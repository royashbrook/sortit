...
function cube(key: string, a: string, b: string, design: 'classic' | 'smirk' | 'angry' | 'visor' | 'wide'): PieceArt {
  const eyes = {
...
function ball(key: string, a: string, b: string, design: 'split' | 'core'): PieceArt {
...
function ship(key: string, a: string, b: string, design: 'tall' | 'low'): PieceArt {
...
function ufo(key: string, a: string, b: string): PieceArt {
  return {
...
function wave(key: string, a: string, b: string): PieceArt {
  return {

...
import { PARS } from './pars.ts'
import { optimal } from './solver.ts'
import type { Board, StarCount } from './types.ts'

export const STAR_SLACK = { three: 2, two: 6 }

export function parFor(board: Board): number | null {
...
export function starsFor(moves: number, par: number | null | undefined, fallbackGoal: number | null | undefined): StarCount {
